...
public class STListActivityFragment extends SearchHelperFragment {
    ...
    public View onFragmentBind(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        this.l4 = new ChaptersAdapter(r(), this.n4, "title", R.layout.f1340list_view_item_ripple_goto_arrow) {
            public void e0(RecyclerView.ViewHolder viewHolder, final Bundle bundle, final int i2) {
                ...
                if (!bundle.getString("leaf").equals(IcyHeaders.a3)) {
                    if (bundle.getString("docName").length() > 0) {
                        rippleTextGotoViewHolder.L.setVisibility(0);
                        rippleTextGotoViewHolder.K.setVisibility(0);
                        rippleTextGotoViewHolder.K.setOnClickListener(new View.OnClickListener() {
                            public void onClick(View view) {
                                STListActivityFragment sTListActivityFragment = STListActivityFragment.this;
                                sTListActivityFragment.k4.A1(sTListActivityFragment.h4, bundle.getString("docName"), (String[]) null, (String) null);
                            }
                        });
                    } else {
                        rippleTextGotoViewHolder.L.setVisibility(0);
                ...
                rippleTextGotoViewHolder.J.setOnClickListener(new View.OnClickListener() {
                    public void onClick(View view) {
                        STListActivityFragment.this.i3(bundle, i2);
                    }
                });
            }
        ...
        this.A4 = new SpellSearchAdapter(r(), this.o4, "text", (String) null, R.layout.f1346list_view_item_ripple_text_full) {
            public void e0(RecyclerView.ViewHolder viewHolder, final Bundle bundle, int i2) {
                ...
                rippleTextFullViewHolder.M.setOnClickListener(new View.OnClickListener() {
                    public void onClick(View view) {
                        STListActivityFragment.this.V2();
                        STListActivityFragment sTListActivityFragment = STListActivityFragment.this;
                        sTListActivityFragment.k4.A1(sTListActivityFragment.h4, bundle.getString("contentId"), (String[]) null, (String) null);
                    }
                });
            }
            ...
            public void h0(Bundle bundle) {
                STListActivityFragment.this.V2();
                STListActivityFragment.this.s4.k0(bundle.getString("word"), true);
            }
    ...
    public ArrayList<Bundle> a3(String str) {
        ...
        return compressHelper.V(bundle, "Select * from search where search match '(text:" + str + "*) AND (type:1)' order by type asc");
    }
    ...
    public void i3(Bundle bundle, int i2) {
        V2();
        if (bundle.getString("leaf").equals(IcyHeaders.a3)) {
            this.k4.A1(this.h4, bundle.getString("docName"), (String[]) null, (String) null);
            return;
        }
        Bundle bundle2 = new Bundle();
        bundle2.putBundle("DB", this.h4);
        bundle2.putString("ParentId", bundle.getString("id"));
        this.k4.N(STListActivity.class, STListActivityFragment.class, bundle2);
    }
}
