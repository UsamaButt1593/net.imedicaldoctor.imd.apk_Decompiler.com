...
public class FTListActivityFragment extends SearchHelperFragment {
    ...
    public View U0(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        this.l4 = new ChaptersAdapter(r(), this.n4, "title", R.layout.f1340list_view_item_ripple_goto_arrow) {
            public void e0(RecyclerView.ViewHolder viewHolder, final Bundle bundle, final int i2) {
                ...
                rippleInfoTextViewHolder.I.setText(bundle.getString("title"));
                rippleInfoTextViewHolder.L.setVisibility(8);
                rippleInfoTextViewHolder.J.setVisibility(8);
                if (!bundle.getString("leaf").equals(IcyHeaders.a3)) {
                    if (bundle.getString("docName").length() > 0) {
                        rippleInfoTextViewHolder.L.setVisibility(0);
                        rippleInfoTextViewHolder.J.setVisibility(0);
                        rippleInfoTextViewHolder.J.setOnClickListener(new View.OnClickListener() {
                            public void onClick(View view) {
                                ...
                                fTListActivityFragment.k4.A1(fTListActivityFragment.h4, bundle.getString("docName"), (String[]) null, (String) null);
                            }
                        });
                    } else {
                        rippleInfoTextViewHolder.L.setVisibility(0);
                ...
                rippleInfoTextViewHolder.K.setOnClickListener(new View.OnClickListener() {
                    public void onClick(View view) {
                        FTListActivityFragment.this.i3(bundle, i2);
                    }
                });
            }
        ...
        this.A4 = new SpellSearchAdapter(r(), this.o4, "text", (String) null, R.layout.f1346list_view_item_ripple_text_full) {
            public void e0(RecyclerView.ViewHolder viewHolder, final Bundle bundle, int i2) {
                ...
                rippleTextFullViewHolder.M.setOnClickListener(new View.OnClickListener() {
                    public void onClick(View view) {
                        FTListActivityFragment.this.V2();
                        FTListActivityFragment fTListActivityFragment = FTListActivityFragment.this;
                        fTListActivityFragment.k4.A1(fTListActivityFragment.h4, bundle.getString("contentId"), (String[]) null, (String) null);
                    }
                });
            }
            ...
            public void h0(Bundle bundle) {
                FTListActivityFragment.this.V2();
                FTListActivityFragment.this.s4.k0(bundle.getString("word"), true);
            }
    ...
    public void i3(Bundle bundle, int i2) {
        ...
        if (bundle.getString("leaf").equals("0")) {
            ...
            this.k4.N(FTListActivity.class, FTListActivityFragment.class, bundle2);
            return;
        }
