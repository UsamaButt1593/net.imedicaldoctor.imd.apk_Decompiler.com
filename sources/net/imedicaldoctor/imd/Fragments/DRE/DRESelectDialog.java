...
public class DRESelectDialog extends DialogFragment {
    public Dialog U2(Bundle bundle) {
        ...
        recyclerView.setAdapter(new ChaptersAdapter(r(), parcelableArrayList, string, R.layout.f1344list_view_item_ripple_text_check) {
            public void e0(RecyclerView.ViewHolder viewHolder, final Bundle bundle, final int i2) {
                ...
                rippleTextCheckViewHolder.I.setTypeface(ResourcesCompat.j(DRESelectDialog.this.r(), R.font.f782iransans));
                if (i2 == i2) {
                ...
                rippleTextCheckViewHolder.J.setOnClickListener(new View.OnClickListener() {
                    public void onClick(View view) {
                        DRESelectDialog.this.N2();
                        DRESelectDialog.this.g3(bundle, i2);
                    }
                });
            }
    ...
    public void g3(Bundle bundle, int i2) {
        if (l0() instanceof DREMainActivityFragment) {
            ((DREMainActivityFragment) l0()).r3(y().getString("Type"), bundle, i2);
        }
    }
}
