...
public final class LruCacheKt {
    ...
    public static /* synthetic */ LruCache b(int i2, Function2 function2, Function1 function1, Function4 function4, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            function2 = LruCacheKt$lruCache$1.X;
        }
        if ((i3 & 4) != 0) {
            function1 = LruCacheKt$lruCache$2.X;
        }
        if ((i3 & 8) != 0) {
            function4 = LruCacheKt$lruCache$3.X;
        }
        return new LruCacheKt$lruCache$4(i2, function2, function1, function4);
    }
}
