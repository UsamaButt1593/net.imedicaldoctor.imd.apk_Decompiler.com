...
public final /* synthetic */ class g {
    static {
        String str = TypedValues.TransitionType.f4024a;
    }
    ...
    public static int b(int i2) {
        ...
        switch (i2) {
            case TypedValues.TransitionType.f4033j:
                return 2;
            case TypedValues.TransitionType.f4034k:
            case TypedValues.TransitionType.f4035l:
                return 8;
            default:
                switch (i2) {
                    case TypedValues.TransitionType.o:
                    case TypedValues.TransitionType.q:
                        return 8;
                    case TypedValues.TransitionType.p:
                        return 4;
                    default:
                        return -1;
                }
