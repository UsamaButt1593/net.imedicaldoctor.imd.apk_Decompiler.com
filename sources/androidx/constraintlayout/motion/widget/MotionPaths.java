...
class MotionPaths implements Comparable<MotionPaths> {
    ...
    float f3;
    MotionController g3;
    LinkedHashMap<String, ConstraintAttribute> h3;
    int i3;
    int j3;
    double[] k3;
    double[] l3;
    ...
    public MotionPaths() {
        ...
        this.i3 = 0;
        this.k3 = new double[18];
        this.l3 = new double[18];
    }
    ...
    public void a(ConstraintSet.Constraint constraint) {
        this.s = Easing.c(constraint.f4713d.f4749d);
        ConstraintSet.Motion motion = constraint.f4713d;
        this.d3 = motion.f4750e;
        this.e3 = motion.f4747b;
        this.b3 = motion.f4754i;
        this.X = motion.f4751f;
        this.j3 = motion.f4748c;
        this.c3 = constraint.f4712c.f4764e;
        this.f3 = constraint.f4714e.D;
        for (String next : constraint.f4716g.keySet()) {
            ...
            if (constraintAttribute != null && constraintAttribute.n()) {
                this.h3.put(next, constraintAttribute);
            }
        }
    }
    ...
    public void c(MotionController motionController) {
        motionController.A((double) this.c3);
    }
    ...
    public void i(double d2, int[] iArr, double[] dArr, float[] fArr, int i2) {
        ...
        MotionController motionController = this.g3;
        if (motionController != null) {
            float[] fArr2 = new float[2];
            motionController.m(d2, fArr2, new float[2]);
            float f8 = fArr2[0];
            float f9 = fArr2[1];
            double d4 = (double) f8;
            double d5 = (double) f2;
    ...
    public void j(double d2, int[] iArr, double[] dArr, float[] fArr, double[] dArr2, float[] fArr2) {
        ...
        if (motionController != null) {
            ...
            motionController.m(d2, fArr3, fArr4);
            float f17 = fArr3[0];
            float f18 = fArr3[1];
            float f19 = fArr4[0];
            double d4 = (double) f4;
    ...
    public int l(String str, double[] dArr, int i2) {
        ConstraintAttribute constraintAttribute = this.h3.get(str);
        int i4 = 0;
    ...
    public void n(int[] iArr, double[] dArr, float[] fArr, int i2) {
        ...
        MotionController motionController = this.g3;
        if (motionController != null) {
            float n2 = motionController.n();
            double d2 = (double) f2;
            double d4 = (double) f4;
            f4 = (float) ((((double) this.g3.o()) - (d2 * Math.cos(d4))) - ((double) (f6 / 2.0f)));
            f2 = (float) ((((double) n2) + (Math.sin(d4) * d2)) - ((double) (f5 / 2.0f)));
        }
        float f8 = f5 + f2;
        float f9 = f6 + f4;
    ...
    /* access modifiers changed from: package-private */
    public void p(KeyPosition keyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        KeyPosition keyPosition2 = keyPosition;
        MotionPaths motionPaths3 = motionPaths;
        MotionPaths motionPaths4 = motionPaths2;
        float f2 = ((float) keyPosition2.f4375a) / 100.0f;
        this.Y = f2;
        this.X = keyPosition2.H;
        float f4 = Float.isNaN(keyPosition2.I) ? f2 : keyPosition2.I;
        float f5 = Float.isNaN(keyPosition2.J) ? f2 : keyPosition2.J;
        ...
        float f18 = Float.isNaN(keyPosition3.K) ? f2 : keyPosition3.K;
        float f19 = 0.0f;
        float f20 = Float.isNaN(keyPosition3.N) ? 0.0f : keyPosition3.N;
        if (!Float.isNaN(keyPosition3.L)) {
            f2 = keyPosition3.L;
        }
        ...
        this.s = Easing.c(keyPosition3.F);
        this.d3 = keyPosition3.G;
    }

    /* access modifiers changed from: package-private */
    public void q(KeyPosition keyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        KeyPosition keyPosition2 = keyPosition;
        MotionPaths motionPaths3 = motionPaths;
        MotionPaths motionPaths4 = motionPaths2;
        float f2 = ((float) keyPosition2.f4375a) / 100.0f;
        ...
        KeyPosition keyPosition3 = keyPosition;
        float f20 = Float.isNaN(keyPosition3.L) ? 0.0f : keyPosition3.L;
        float f21 = (-f13) * f20;
        float f22 = f12 * f20;
        this.i3 = 1;
        MotionPaths motionPaths5 = motionPaths;
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:17:0x0068, code lost:
        if (java.lang.Float.isNaN(r9.L) != false) goto L_0x006d;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:33:0x00bb, code lost:
        if (java.lang.Float.isNaN(r9.L) != false) goto L_0x006d;
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public void r(int r7, int r8, androidx.constraintlayout.motion.widget.KeyPosition r9, androidx.constraintlayout.motion.widget.MotionPaths r10, androidx.constraintlayout.motion.widget.MotionPaths r11) {
        /*
            r6 = this;
            int r7 = r9.f4375a
            float r7 = (float) r7
        ...
        L_0x00be:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.constraintlayout.motion.widget.MotionPaths.r(int, int, androidx.constraintlayout.motion.widget.KeyPosition, androidx.constraintlayout.motion.widget.MotionPaths, androidx.constraintlayout.motion.widget.MotionPaths):void");
    }

    /* access modifiers changed from: package-private */
    public void s(int i2, int i4, KeyPosition keyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        KeyPosition keyPosition2 = keyPosition;
        MotionPaths motionPaths3 = motionPaths;
        MotionPaths motionPaths4 = motionPaths2;
        float f2 = ((float) keyPosition2.f4375a) / 100.0f;
        ...
        this.i3 = 2;
        KeyPosition keyPosition3 = keyPosition;
        if (!Float.isNaN(keyPosition3.K)) {
            this.X2 = (float) ((int) (keyPosition3.K * ((float) ((int) (((float) i2) - this.Z2)))));
        }
        if (!Float.isNaN(keyPosition3.L)) {
            this.Y2 = (float) ((int) (keyPosition3.L * ((float) ((int) (((float) i4) - this.a3)))));
        }
        this.e3 = this.e3;
        this.s = Easing.c(keyPosition3.F);
        this.d3 = keyPosition3.G;
    ...
    /* access modifiers changed from: package-private */
    public void w(float f2, View view, int[] iArr, double[] dArr, double[] dArr2, double[] dArr3, boolean z) {
        float f4;
        float f5;
        View view2 = view;
        int[] iArr2 = iArr;
        ...
        if (motionController != null) {
            ...
            float[] fArr2 = new float[2];
            motionController.m((double) f2, fArr, fArr2);
            float f18 = fArr[0];
            float f19 = fArr[1];
            float f20 = fArr2[0];
            float f21 = fArr2[1];
            ...
            if (!Float.isNaN(f17)) {
                view2.setRotation((float) (((double) f17) + Math.toDegrees(Math.atan2((double) cos2, (double) sin2))));
            }
            f6 = f23;
            f7 = cos;
        } else {
        ...
        if (view2 instanceof FloatLayout) {
            ((FloatLayout) view2).a(f6, f7, f8 + f6, f7 + f4);
            return;
        }
        float f25 = f6 + 0.5f;
        int i7 = (int) f25;
    ...
    public void x(MotionController motionController, MotionPaths motionPaths) {
    ...
    public MotionPaths(int i2, int i4, KeyPosition keyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        int i5 = Key.f4366f;
        this.d3 = i5;
        this.e3 = i5;
        this.f3 = Float.NaN;
        ...
        this.k3 = new double[18];
        this.l3 = new double[18];
        if (motionPaths.e3 != Key.f4366f) {
            r(i2, i4, keyPosition, motionPaths, motionPaths2);
            return;
        }
        ...
        if (i6 == 1) {
            ...
            s(i2, i4, keyPosition, motionPaths, motionPaths2);
        }
    }
}
