...
public final class PreferenceDataStore implements DataStore<Preferences> {
    ...
    private final DataStore<Preferences> f6957a;

    public PreferenceDataStore(@NotNull DataStore<Preferences> dataStore) {
        Intrinsics.p(dataStore, "delegate");
        this.f6957a = dataStore;
    }

    @Nullable
    public Object a(@NotNull Function2<? super Preferences, ? super Continuation<? super Preferences>, ? extends Object> function2, @NotNull Continuation<? super Preferences> continuation) {
        return this.f6957a.a(new PreferenceDataStore$updateData$2(function2, (Continuation<? super PreferenceDataStore$updateData$2>) null), continuation);
    }

    @NotNull
    public Flow<Preferences> getData() {
        return this.f6957a.getData();
    }
}
