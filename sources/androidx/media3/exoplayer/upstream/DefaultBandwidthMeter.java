...
public final class DefaultBandwidthMeter implements BandwidthMeter, TransferListener {
    ...
    public static final ImmutableList<Long> p = ImmutableList.O(4300000L, 3200000L, 2400000L, 1700000L, 860000L);
    public static final ImmutableList<Long> q = ImmutableList.O(1500000L, 980000L, 750000L, 520000L, 290000L);
    public static final ImmutableList<Long> r;
    public static final ImmutableList<Long> s = ImmutableList.O(2500000L, 1700000L, 1200000L, 970000L, 680000L);
    public static final ImmutableList<Long> t = ImmutableList.O(4700000L, 2800000L, 2100000L, 1700000L, 980000L);
    ...
    private final ImmutableMap<Integer, Long> f12531a;

    /* renamed from: b  reason: collision with root package name */
    private final BandwidthMeter.EventListener.EventDispatcher f12532b;

    /* renamed from: c  reason: collision with root package name */
    private final Clock f12533c;
    ...
    private final SlidingPercentile f12535e;
    @GuardedBy("this")
    ...
    public static final class Builder {
        ...
        /* renamed from: b  reason: collision with root package name */
        private Map<Integer, Long> f12546b;

        /* renamed from: c  reason: collision with root package name */
        private int f12547c;

        /* renamed from: d  reason: collision with root package name */
        private Clock f12548d;

        /* renamed from: e  reason: collision with root package name */
        private boolean f12549e;

        public Builder(Context context) {
            this.f12545a = context == null ? null : context.getApplicationContext();
            this.f12546b = b(Util.i0(context));
            this.f12547c = 2000;
            this.f12548d = Clock.f9502a;
            this.f12549e = true;
        }
        ...
        private static Map<Integer, Long> b(String str) {
            ...
            ImmutableList<Long> immutableList = DefaultBandwidthMeter.p;
            hashMap.put(2, immutableList.get(k2[0]));
            hashMap.put(3, DefaultBandwidthMeter.q.get(k2[1]));
            hashMap.put(4, DefaultBandwidthMeter.r.get(k2[2]));
            hashMap.put(5, DefaultBandwidthMeter.s.get(k2[3]));
            hashMap.put(10, DefaultBandwidthMeter.t.get(k2[4]));
            hashMap.put(9, DefaultBandwidthMeter.u.get(k2[5]));
            hashMap.put(7, immutableList.get(k2[0]));
            return hashMap;
        }

        public DefaultBandwidthMeter a() {
            return new DefaultBandwidthMeter(this.f12545a, this.f12546b, this.f12547c, this.f12548d, this.f12549e);
        }
        ...
        public Builder d(int i2, long j2) {
            this.f12546b.put(Integer.valueOf(i2), Long.valueOf(j2));
            return this;
        }

        @CanIgnoreReturnValue
        public Builder e(long j2) {
            for (Integer intValue : this.f12546b.keySet()) {
    ...
    static {
        ...
        r = ImmutableList.O(valueOf, 1300000L, 1000000L, 860000L, 610000L);
        u = ImmutableList.O(2700000L, valueOf, 1600000L, 1300000L, 1000000L);
    }

    private DefaultBandwidthMeter(@Nullable Context context, Map<Integer, Long> map, int i2, Clock clock, boolean z2) {
        this.f12531a = ImmutableMap.g(map);
        this.f12532b = new BandwidthMeter.EventListener.EventDispatcher();
        this.f12535e = new SlidingPercentile(i2);
        this.f12533c = clock;
        this.f12534d = z2;
        if (context != null) {
    ...
    private long m(int i2) {
        Long l2 = this.f12531a.get(Integer.valueOf(i2));
        if (l2 == null) {
            l2 = this.f12531a.get(0);
        }
        if (l2 == null) {
            l2 = 1000000L;
        }
    ...
    private void p(int i2, long j2, long j3) {
        if (i2 != 0 || j2 != 0 || j3 != this.f12542l) {
            this.f12542l = j3;
            this.f12532b.c(i2, j2, j3);
        }
    }
    ...
    public synchronized void q(int r9) {
        /*
            r8 = this;
            monitor-enter(r8)
            int r0 = r8.f12543m     // Catch:{ all -> 0x000b }
            if (r0 == 0) goto L_0x000d
            boolean r1 = r8.f12534d     // Catch:{ all -> 0x000b }
        ...
        L_0x000b:
            ...
            goto L_0x0057
        L_0x000d:
            boolean r1 = r8.f12544n     // Catch:{ all -> 0x000b }
            if (r1 == 0) goto L_0x0013
            int r9 = r8.o     // Catch:{ all -> 0x000b }
        L_0x0013:
            if (r0 != r9) goto L_0x0017
            monitor-exit(r8)
            return
        L_0x0017:
            r8.f12543m = r9     // Catch:{ all -> 0x000b }
            r0 = 1
        ...
        L_0x0023:
            ...
            r8.f12541k = r0     // Catch:{ all -> 0x000b }
            androidx.media3.common.util.Clock r9 = r8.f12533c     // Catch:{ all -> 0x000b }
            long r0 = r9.b()     // Catch:{ all -> 0x000b }
            int r9 = r8.f12536f     // Catch:{ all -> 0x000b }
            if (r9 <= 0) goto L_0x003a
            long r2 = r8.f12537g     // Catch:{ all -> 0x000b }
            long r2 = r0 - r2
        ...
        L_0x003a:
            ...
            r3 = 0
        L_0x003c:
            long r4 = r8.f12538h     // Catch:{ all -> 0x000b }
            long r6 = r8.f12541k     // Catch:{ all -> 0x000b }
            r2 = r8
            r2.p(r3, r4, r6)     // Catch:{ all -> 0x000b }
            r8.f12537g = r0     // Catch:{ all -> 0x000b }
            r0 = 0
            r8.f12538h = r0     // Catch:{ all -> 0x000b }
            r8.f12540j = r0     // Catch:{ all -> 0x000b }
            r8.f12539i = r0     // Catch:{ all -> 0x000b }
            androidx.media3.exoplayer.upstream.SlidingPercentile r9 = r8.f12535e     // Catch:{ all -> 0x000b }
    ...
    public synchronized void g(DataSource dataSource, DataSpec dataSpec, boolean z2) {
        try {
            if (o(dataSpec, z2)) {
                Assertions.i(this.f12536f > 0);
                long b2 = this.f12533c.b();
                int i2 = (int) (b2 - this.f12537g);
                this.f12539i += (long) i2;
                long j2 = this.f12540j;
                long j3 = this.f12538h;
                this.f12540j = j2 + j3;
                if (i2 > 0) {
                    this.f12535e.c((int) Math.sqrt((double) j3), (((float) j3) * 8000.0f) / ((float) i2));
                    if (this.f12539i < ExoPlayer.a1) {
                        if (this.f12540j >= PlaybackStateCompat.y3) {
                        }
                        p(i2, this.f12538h, this.f12541k);
                        this.f12537g = b2;
                        this.f12538h = 0;
                    }
                    this.f12541k = (long) this.f12535e.f(0.5f);
                    p(i2, this.f12538h, this.f12541k);
                    this.f12537g = b2;
                    this.f12538h = 0;
                }
