...
public final class ToInt16PcmAudioProcessor extends BaseAudioProcessor {
    ...
    public void e(java.nio.ByteBuffer r12) {
        /*
            ...
            int r1 = r12.limit()
            int r2 = r1 - r0
            androidx.media3.common.audio.AudioProcessor$AudioFormat r3 = r11.f9386b
            int r3 = r3.f9384c
        ...
        L_0x00bf:
            ...
            float r3 = androidx.media3.common.util.Util.v(r3, r4, r5)
        ...
        L_0x00fa:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.media3.common.audio.ToInt16PcmAudioProcessor.e(java.nio.ByteBuffer):void");
    }
    ...
    public AudioProcessor.AudioFormat h(AudioProcessor.AudioFormat audioFormat) throws AudioProcessor.UnhandledAudioFormatException {
        ...
        if (i2 == 3 || i2 == 2 || i2 == 268435456 || i2 == 21 || i2 == 1342177280 || i2 == 22 || i2 == 1610612736 || i2 == 4) {
            return i2 != 2 ? new AudioProcessor.AudioFormat(audioFormat.f9382a, audioFormat.f9383b, 2) : AudioProcessor.AudioFormat.f9381e;
        }
