...
final class EdgeToEdgeApi26 implements EdgeToEdgeImpl {
    ...
    public void a(@NotNull SystemBarStyle systemBarStyle, @NotNull SystemBarStyle systemBarStyle2, @NotNull Window window, @NotNull View view, boolean z, boolean z2) {
        ...
        window.setNavigationBarColor(systemBarStyle2.g(z2));
        WindowInsetsControllerCompat windowInsetsControllerCompat = new WindowInsetsControllerCompat(window, view);
        windowInsetsControllerCompat.i(!z);
        windowInsetsControllerCompat.h(!z2);
    }
}
