...
public class AppCompatMultiAutoCompleteTextView extends MultiAutoCompleteTextView implements TintableBackgroundView, EmojiCompatConfigurationView, TintableCompoundDrawablesView {
    ...
    public final class InspectionCompanion implements android.view.inspector.InspectionCompanion<AppCompatMultiAutoCompleteTextView> {
        ...
        public void readProperties(@NonNull AppCompatMultiAutoCompleteTextView appCompatMultiAutoCompleteTextView, @NonNull PropertyReader propertyReader) {
            if (this.f3110a) {
                propertyReader.readObject(this.f3111b, appCompatMultiAutoCompleteTextView.getBackgroundTintList());
                propertyReader.readObject(this.f3112c, appCompatMultiAutoCompleteTextView.getBackgroundTintMode());
                propertyReader.readObject(this.f3113d, appCompatMultiAutoCompleteTextView.getCompoundDrawableTintList());
                propertyReader.readObject(this.f3114e, appCompatMultiAutoCompleteTextView.getCompoundDrawableTintMode());
                return;
            }
            throw C0004e.a();
        }
        ...
        public void mapProperties(@NonNull PropertyMapper propertyMapper) {
            this.f3111b = propertyMapper.mapObject("backgroundTint", R.attr.b0);
            this.f3112c = propertyMapper.mapObject("backgroundTintMode", R.attr.c0);
            this.f3113d = propertyMapper.mapObject("drawableTint", R.attr.l1);
            this.f3114e = propertyMapper.mapObject("drawableTintMode", R.attr.m1);
            this.f3110a = true;
        }
    }
