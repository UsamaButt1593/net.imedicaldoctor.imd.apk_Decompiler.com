...
public class AppCompatCheckBox extends CheckBox implements TintableCompoundButton, TintableBackgroundView, EmojiCompatConfigurationView, TintableCompoundDrawablesView {
    ...
    public final class InspectionCompanion implements android.view.inspector.InspectionCompanion<AppCompatCheckBox> {
        ...
        public void readProperties(@NonNull AppCompatCheckBox appCompatCheckBox, @NonNull PropertyReader propertyReader) {
            if (this.f3048a) {
                propertyReader.readObject(this.f3049b, appCompatCheckBox.getBackgroundTintList());
                propertyReader.readObject(this.f3050c, appCompatCheckBox.getBackgroundTintMode());
                propertyReader.readObject(this.f3051d, appCompatCheckBox.getButtonTintList());
                propertyReader.readObject(this.f3052e, appCompatCheckBox.getButtonTintMode());
                propertyReader.readObject(this.f3053f, appCompatCheckBox.getCompoundDrawableTintList());
                propertyReader.readObject(this.f3054g, appCompatCheckBox.getCompoundDrawableTintMode());
                return;
            }
            throw C0004e.a();
        }
        ...
        public void mapProperties(@NonNull PropertyMapper propertyMapper) {
            this.f3049b = propertyMapper.mapObject("backgroundTint", R.attr.b0);
            this.f3050c = propertyMapper.mapObject("backgroundTintMode", R.attr.c0);
            this.f3051d = propertyMapper.mapObject("buttonTint", R.attr.q0);
            this.f3052e = propertyMapper.mapObject("buttonTintMode", R.attr.r0);
            this.f3053f = propertyMapper.mapObject("drawableTint", R.attr.l1);
            this.f3054g = propertyMapper.mapObject("drawableTintMode", R.attr.m1);
            this.f3048a = true;
        }
    }
