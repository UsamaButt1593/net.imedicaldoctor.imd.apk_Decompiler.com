...
public final class ThaiBuddhistDate extends ChronoDateImpl<ThaiBuddhistDate> implements Serializable {
    private static final long Z = -8722293800195731463L;
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f31797a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f31797a     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f31797a     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                int[] r0 = f31797a     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x003e:
                int[] r0 = f31797a     // Catch:{ NoSuchFieldError -> 0x0049 }
            ...
            L_0x0049:
                int[] r0 = f31797a     // Catch:{ NoSuchFieldError -> 0x0054 }
    ...
    public static ThaiBuddhistDate D1(ZoneId zoneId) {
        return w1(Clock.f(zoneId));
    }

    public static ThaiBuddhistDate F1(int i2, int i3, int i4) {
        return ThaiBuddhistChronology.X2.b(i2, i3, i4);
    }

    public static ThaiBuddhistDate Y0(TemporalAccessor temporalAccessor) {
        return ThaiBuddhistChronology.X2.e(temporalAccessor);
    }
    ...
    private int h1() {
        return this.Y.M0() + 543;
    }

    public static ThaiBuddhistDate l1() {
        return w1(Clock.g());
    }

    static ChronoLocalDate m2(DataInput dataInput) throws IOException {
        return ThaiBuddhistChronology.X2.b(dataInput.readInt(), dataInput.readByte(), dataInput.readByte());
    }

    private ThaiBuddhistDate n2(LocalDate localDate) {
        return localDate.equals(this.Y) ? this : new ThaiBuddhistDate(localDate);
    }
    ...
    public static ThaiBuddhistDate w1(Clock clock) {
        return new ThaiBuddhistDate(LocalDate.p2(clock));
    }
    ...
    /* renamed from: T1 */
    public ThaiBuddhistDate q(long j2, TemporalUnit temporalUnit) {
    ...
    /* renamed from: c1 */
    public ThaiBuddhistChronology x() {
        return ThaiBuddhistChronology.X2;
    }

    /* renamed from: d1 */
    public ThaiBuddhistEra y() {
        return (ThaiBuddhistEra) super.y();
    }

    /* renamed from: e2 */
    public ThaiBuddhistDate h(TemporalAmount temporalAmount) {
        return (ThaiBuddhistDate) super.h(temporalAmount);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ThaiBuddhistDate) {
            return this.Y.equals(((ThaiBuddhistDate) obj).Y);
        }
        return false;
    }
    ...
    public ValueRange f(TemporalField temporalField) {
        ...
        if (m(temporalField)) {
            ...
            int i2 = AnonymousClass1.f31797a[chronoField.ordinal()];
            if (i2 == 1 || i2 == 2 || i2 == 3) {
            ...
            return ValueRange.k(1, h1() <= 0 ? (-(h2.e() + 543)) + 1 : 543 + h2.d());
        }
    ...
    /* access modifiers changed from: package-private */
    /* renamed from: i2 */
    public ThaiBuddhistDate L0(long j2) {
        return n2(this.Y.L2(j2));
    }

    /* renamed from: j1 */
    public ThaiBuddhistDate o(long j2, TemporalUnit temporalUnit) {
        return (ThaiBuddhistDate) super.o(j2, temporalUnit);
    }
    ...
    /* renamed from: k1 */
    public ThaiBuddhistDate g(TemporalAmount temporalAmount) {
        return (ThaiBuddhistDate) super.g(temporalAmount);
    }
    ...
    public long p(TemporalField temporalField) {
        ...
        int i2 = AnonymousClass1.f31797a[((ChronoField) temporalField).ordinal()];
        int i3 = 1;
        if (i2 == 4) {
            int h1 = h1();
            if (h1 < 1) {
    ...
    public org.threeten.bp.chrono.ThaiBuddhistDate q0(org.threeten.bp.temporal.TemporalField r8, long r9) {
        /*
            r7 = this;
            ...
            return r7
        L_0x0010:
            int[] r1 = org.threeten.bp.chrono.ThaiBuddhistDate.AnonymousClass1.f31797a
            int r2 = r0.ordinal()
            r2 = r1[r2]
            r3 = 7
            r4 = 6
            ...
            goto L_0x0052
        L_0x0025:
            org.threeten.bp.chrono.ThaiBuddhistChronology r8 = r7.x()
            org.threeten.bp.temporal.ValueRange r8 = r8.E(r0)
            r8.b(r9, r0)
            long r0 = r7.e1()
            long r9 = r9 - r0
            org.threeten.bp.chrono.ThaiBuddhistDate r8 = r7.L0(r9)
            return r8
        L_0x003a:
            org.threeten.bp.chrono.ThaiBuddhistChronology r2 = r7.x()
        ...
        L_0x0052:
            ...
            org.threeten.bp.chrono.ThaiBuddhistDate r8 = r7.n2(r8)
            return r8
        L_0x005d:
        ...
        L_0x0092:
            ...
            return r8
        */
        throw new UnsupportedOperationException("Method not decompiled: org.threeten.bp.chrono.ThaiBuddhistDate.q0(org.threeten.bp.temporal.TemporalField, long):org.threeten.bp.chrono.ThaiBuddhistDate");
    }
