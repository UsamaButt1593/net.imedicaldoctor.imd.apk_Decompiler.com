...
public final class ThaiBuddhistChronology extends Chronology implements Serializable {
    public static final ThaiBuddhistChronology X2 = new ThaiBuddhistChronology();
    private static final long Y2 = 2775954514031616474L;
    static final int Z2 = 543;
    private static final HashMap<String, String[]> a3;
    private static final HashMap<String, String[]> b3;
    private static final HashMap<String, String[]> c3;
    private static final String d3 = "en";
    private static final String e3 = "th";
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f31796a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f31796a     // Catch:{ NoSuchFieldError -> 0x0028 }
    ...
    static {
        ...
        c3 = hashMap3;
        hashMap.put(d3, new String[]{"BB", "BE"});
        hashMap.put("th", new String[]{"BB", "BE"});
        hashMap2.put(d3, new String[]{"B.B.", "B.E."});
        hashMap2.put("th", new String[]{"พ.ศ.", "ปีก่อนคริสต์กาลที่"});
        hashMap3.put(d3, new String[]{"Before Buddhist", "Budhhist Era"});
    ...
    public ValueRange E(ChronoField chronoField) {
        int i2 = AnonymousClass1.f31796a[chronoField.ordinal()];
        if (i2 == 1) {
            ValueRange h2 = ChronoField.PROLEPTIC_MONTH.h();
            return ValueRange.k(h2.e() + 6516, h2.d() + 6516);
        } else if (i2 == 2) {
            ValueRange h3 = ChronoField.YEAR.h();
            return ValueRange.l(1, (-(h3.e() + 543)) + 1, h3.d() + 543);
        } else if (i2 != 3) {
            return chronoField.h();
        } else {
            ValueRange h4 = ChronoField.YEAR.h();
            return ValueRange.k(h4.e() + 543, h4.d() + 543);
        }
    }
    ...
    public ThaiBuddhistDate b(int i2, int i3, int i4) {
        return new ThaiBuddhistDate(LocalDate.r2(i2 - 543, i3, i4));
    }

    /* renamed from: R */
    public ThaiBuddhistDate c(Era era, int i2, int i3, int i4) {
        return (ThaiBuddhistDate) super.c(era, i2, i3, i4);
    }

    /* renamed from: S */
    public ThaiBuddhistDate e(TemporalAccessor temporalAccessor) {
        return temporalAccessor instanceof ThaiBuddhistDate ? (ThaiBuddhistDate) temporalAccessor : new ThaiBuddhistDate(LocalDate.c1(temporalAccessor));
    }

    /* renamed from: T */
    public ThaiBuddhistDate f(long j2) {
        return new ThaiBuddhistDate(LocalDate.w2(j2));
    }

    /* renamed from: U */
    public ThaiBuddhistDate g() {
        return (ThaiBuddhistDate) super.g();
    }

    /* renamed from: W */
    public ThaiBuddhistDate h(Clock clock) {
        Jdk8Methods.j(clock, "clock");
        return (ThaiBuddhistDate) super.h(clock);
    }

    /* renamed from: Z */
    public ThaiBuddhistDate i(ZoneId zoneId) {
        return (ThaiBuddhistDate) super.i(zoneId);
    }

    /* renamed from: a0 */
    public ThaiBuddhistDate j(int i2, int i3) {
        return new ThaiBuddhistDate(LocalDate.B2(i2 - 543, i3));
    }

    /* renamed from: c0 */
    public ThaiBuddhistDate k(Era era, int i2, int i3) {
        return (ThaiBuddhistDate) super.k(era, i2, i3);
    }

    /* renamed from: d0 */
    public ThaiBuddhistEra o(int i2) {
        return ThaiBuddhistEra.j(i2);
    }
    ...
    public org.threeten.bp.chrono.ThaiBuddhistDate J(java.util.Map<org.threeten.bp.temporal.TemporalField, java.lang.Long> r11, org.threeten.bp.format.ResolverStyle r12) {
        /*
            r10 = this;
            ...
            org.threeten.bp.chrono.ThaiBuddhistDate r11 = r10.f(r11)
            return r11
        L_0x0017:
        ...
        L_0x00f7:
            ...
            org.threeten.bp.chrono.ThaiBuddhistDate r0 = r10.b(r0, r2, r2)
            org.threeten.bp.chrono.ThaiBuddhistDate r0 = r0.L0(r6)
            org.threeten.bp.chrono.ThaiBuddhistDate r11 = r0.K0(r11)
            return r11
        L_0x014c:
            ...
            org.threeten.bp.chrono.ThaiBuddhistDate r12 = r10.b(r0, r1, r2)
            int r12 = r12.F()
            int r11 = java.lang.Math.min(r11, r12)
        L_0x0184:
            org.threeten.bp.chrono.ThaiBuddhistDate r11 = r10.b(r0, r1, r11)
            return r11
        L_0x0189:
            ...
            org.threeten.bp.chrono.ThaiBuddhistDate r0 = r0.q(r8, r1)
            org.threeten.bp.temporal.ChronoUnit r1 = org.threeten.bp.temporal.ChronoUnit.WEEKS
            org.threeten.bp.chrono.ThaiBuddhistDate r0 = r0.q(r5, r1)
            org.threeten.bp.temporal.ChronoUnit r1 = org.threeten.bp.temporal.ChronoUnit.DAYS
            org.threeten.bp.chrono.ThaiBuddhistDate r11 = r0.q(r11, r1)
            return r11
        L_0x01ec:
            ...
            int r11 = r7.m(r8)
            org.threeten.bp.chrono.ThaiBuddhistDate r0 = r10.b(r0, r3, r2)
            int r4 = r4 - r2
            int r4 = r4 * 7
            int r11 = r11 - r2
            int r4 = r4 + r11
            ...
            org.threeten.bp.chrono.ThaiBuddhistDate r11 = r0.q(r4, r11)
        ...
        L_0x0293:
            ...
            org.threeten.bp.chrono.ThaiBuddhistDate r0 = r0.q(r4, r2)
            ...
            org.threeten.bp.chrono.ThaiBuddhistDate r11 = r0.l(r11)
            org.threeten.bp.format.ResolverStyle r0 = org.threeten.bp.format.ResolverStyle.STRICT
        ...
        L_0x02e7:
            ...
            long r11 = r11.longValue()
            long r11 = org.threeten.bp.jdk8.Jdk8Methods.q(r11, r3)
            org.threeten.bp.chrono.ThaiBuddhistDate r0 = r10.j(r0, r2)
            org.threeten.bp.chrono.ThaiBuddhistDate r11 = r0.K0(r11)
            return r11
        L_0x0318:
            long r11 = r11.longValue()
            int r11 = r1.m(r11)
            org.threeten.bp.chrono.ThaiBuddhistDate r11 = r10.j(r0, r11)
            return r11
        L_0x0325:
            ...
            long r11 = r11.longValue()
            long r11 = org.threeten.bp.jdk8.Jdk8Methods.q(r11, r3)
            org.threeten.bp.chrono.ThaiBuddhistDate r2 = r10.b(r6, r2, r2)
            org.threeten.bp.temporal.ChronoUnit r3 = org.threeten.bp.temporal.ChronoUnit.WEEKS
            org.threeten.bp.chrono.ThaiBuddhistDate r0 = r2.q(r0, r3)
            org.threeten.bp.temporal.ChronoUnit r1 = org.threeten.bp.temporal.ChronoUnit.DAYS
            org.threeten.bp.chrono.ThaiBuddhistDate r11 = r0.q(r11, r1)
            return r11
        L_0x0374:
            ...
            int r11 = r5.m(r3)
            org.threeten.bp.chrono.ThaiBuddhistDate r3 = r10.b(r6, r2, r2)
            int r1 = r1 - r2
            int r1 = r1 * 7
            int r11 = r11 - r2
            int r1 = r1 + r11
            long r1 = (long) r1
            org.threeten.bp.chrono.ThaiBuddhistDate r11 = r3.K0(r1)
        ...
        L_0x03b2:
            ...
            long r11 = r11.longValue()
            long r11 = org.threeten.bp.jdk8.Jdk8Methods.q(r11, r3)
            org.threeten.bp.chrono.ThaiBuddhistDate r2 = r10.b(r7, r2, r2)
            org.threeten.bp.temporal.ChronoUnit r3 = org.threeten.bp.temporal.ChronoUnit.WEEKS
            org.threeten.bp.chrono.ThaiBuddhistDate r0 = r2.q(r0, r3)
            org.threeten.bp.temporal.ChronoUnit r1 = org.threeten.bp.temporal.ChronoUnit.DAYS
            org.threeten.bp.chrono.ThaiBuddhistDate r11 = r0.q(r11, r1)
        ...
        L_0x03f9:
            ...
            long r3 = r11.longValue()
            int r11 = r5.m(r3)
            org.threeten.bp.chrono.ThaiBuddhistDate r3 = r10.b(r7, r2, r2)
            int r1 = r1 - r2
            long r1 = (long) r1
            org.threeten.bp.temporal.ChronoUnit r4 = org.threeten.bp.temporal.ChronoUnit.WEEKS
            org.threeten.bp.chrono.ThaiBuddhistDate r1 = r3.q(r1, r4)
            org.threeten.bp.DayOfWeek r11 = org.threeten.bp.DayOfWeek.s(r11)
            org.threeten.bp.temporal.TemporalAdjuster r11 = org.threeten.bp.temporal.TemporalAdjusters.k(r11)
            org.threeten.bp.chrono.ThaiBuddhistDate r11 = r1.l(r11)
            org.threeten.bp.format.ResolverStyle r1 = org.threeten.bp.format.ResolverStyle.STRICT
        ...
        L_0x043f:
            ...
            return r11
        */
        throw new UnsupportedOperationException("Method not decompiled: org.threeten.bp.chrono.ThaiBuddhistChronology.J(java.util.Map, org.threeten.bp.format.ResolverStyle):org.threeten.bp.chrono.ThaiBuddhistDate");
    }
    ...
    public boolean x(long j2) {
        return IsoChronology.X2.x(j2 - 543);
    }

    public ChronoLocalDateTime<ThaiBuddhistDate> y(TemporalAccessor temporalAccessor) {
