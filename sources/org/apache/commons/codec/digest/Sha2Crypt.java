        ...
        if (str4 != null) {
            ...
            if (matcher.find()) {
                if (matcher.group(3) != null) {
                    i3 = Math.max(1000, Math.min(999999999, Integer.parseInt(matcher.group(3))));
                    z = true;
                } else {
                    i3 = 5000;
                    z = false;
                ...
                int i6 = 0;
                while (i6 < length - i4) {
                    System.arraycopy(digest6, 0, bArr3, i6, i4);
                    i6 += i4;
                }
                ...
                int i8 = 0;
                while (i8 < length2 - i4) {
                    System.arraycopy(digest8, 0, bArr4, i8, i4);
                    i8 += i4;
                }
                ...
                while (i9 <= i3 - 1) {
                    ...
                    byte[] bArr5 = bytes;
                    if (i10 != 0) {
                        messageDigest2.update(bArr3, 0, length);
                    } else {
                        messageDigest2.update(digest4, 0, i4);
                    }
                    if (i9 % 3 != 0) {
                        messageDigest2.update(bArr4, 0, length2);
                    }
                    if (i9 % 7 != 0) {
                        messageDigest2.update(bArr3, 0, length);
                    }
