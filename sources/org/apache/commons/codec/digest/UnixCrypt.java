...
public class UnixCrypt {
    ...
    private static int[] desSetKey(byte[] bArr) {
        ...
        while (i10 < 16) {
            ...
            int i12 = i4 | i3;
            int i13 = i2 & 268435455;
            int i14 = i12 & 268435455;
            int[][] iArr3 = SKB;
            int i15 = iArr3[0][i2 & 63] | iArr3[1][((i13 >>> 6) & 3) | ((i13 >>> 7) & 60)] | iArr3[2][((i13 >>> 13) & 15) | ((i13 >>> 14) & 48)] | iArr3[3][((i13 >>> 20) & 1) | ((i13 >>> 21) & 6) | ((i13 >>> 22) & 56)];
            int i16 = iArr3[4][i12 & 63] | iArr3[5][((i14 >>> 7) & 3) | ((i14 >>> 8) & 60)] | iArr3[6][(i14 >>> 15) & 63] | iArr3[7][((i14 >>> 21) & 15) | ((i14 >>> 22) & 48)];
            iArr[i11] = (i16 << 16) | (65535 & i15);
            int i17 = (i16 & SupportMenu.f5941c) | (i15 >>> 16);
            i11 += 2;
            iArr[i11 + 1] = (i17 >>> 28) | (i17 << 4);
            i10++;
            i9 = i13;
            i8 = i14;
        }
    ...
    private static int fourBytesToInt(byte[] bArr, int i2) {
        ...
        int i3 = i2 + 2;
        return (byteToUnsigned(bArr[i2 + 3]) << 24) | (byteToUnsigned(bArr[i2 + 1]) << 8) | byteToUnsigned | (byteToUnsigned(bArr[i3]) << 16);
    }
