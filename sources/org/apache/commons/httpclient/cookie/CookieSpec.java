...
public interface CookieSpec {
    ...
    boolean match(String str, int i2, String str2, boolean z, Cookie cookie);

    Cookie[] match(String str, int i2, String str2, boolean z, Cookie[] cookieArr);

    Cookie[] parse(String str, int i2, String str2, boolean z, String str3) throws MalformedCookieException, IllegalArgumentException;

    Cookie[] parse(String str, int i2, String str2, boolean z, Header header) throws MalformedCookieException, IllegalArgumentException;
    ...
    void validate(String str, int i2, String str2, boolean z, Cookie cookie) throws MalformedCookieException, IllegalArgumentException;
}
