...
final class SessionsSettings$Companion$dataStore$2 extends Lambda implements Function1<CorruptionException, Preferences> {
    public static final SessionsSettings$Companion$dataStore$2 X = new SessionsSettings$Companion$dataStore$2();
    ...
    public final Preferences f(@NotNull CorruptionException corruptionException) {
        ...
        Log.w("SessionsSettings", "CorruptionException in settings DataStore in " + ProcessDetailsProvider.f25074a.e() + ClassUtils.PACKAGE_SEPARATOR_CHAR, corruptionException);
