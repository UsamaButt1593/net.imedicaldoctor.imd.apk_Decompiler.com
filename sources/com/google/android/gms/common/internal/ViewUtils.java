...
public class ViewUtils {
    ...
    @KeepForSdk
    @Nullable
    public static String a(@NonNull String str, @NonNull String str2, @NonNull Context context, @NonNull AttributeSet attributeSet, boolean z, boolean z2, @NonNull String str3) {
