...
public class RangeSlider extends BaseSlider<RangeSlider, OnChangeListener, OnSliderTouchListener> {
    ...
    public interface OnChangeListener extends BaseOnChangeListener<RangeSlider> {
        ...
        void b(@NonNull RangeSlider rangeSlider, float f2, boolean z);
    }
    ...
    public interface OnSliderTouchListener extends BaseOnSliderTouchListener<RangeSlider> {
        ...
        void f(@NonNull RangeSlider rangeSlider);
    }
    ...
    public void onRestoreInstanceState(@Nullable Parcelable parcelable) {
        ...
        this.N4 = rangeSliderState.s;
        int c2 = rangeSliderState.X;
        this.O4 = c2;
        setSeparationUnit(c2);
    }

    @NonNull
    public Parcelable onSaveInstanceState() {
        RangeSliderState rangeSliderState = new RangeSliderState(super.onSaveInstanceState());
        float unused = rangeSliderState.s = this.N4;
        int unused2 = rangeSliderState.X = this.O4;
    ...
    public RangeSlider(@NonNull Context context, @Nullable AttributeSet attributeSet, int i2) {
        ...
        TypedArray k2 = ThemeEnforcement.k(context, attributeSet, R.styleable.Sr, i2, BaseSlider.D4, new int[0]);
        int i3 = R.styleable.Ur;
        if (k2.hasValue(i3)) {
            setValues(O0(k2.getResources().obtainTypedArray(k2.getResourceId(i3, 0))));
        }
        this.N4 = k2.getDimension(R.styleable.Tr, 0.0f);
        k2.recycle();
    }
}
