...
class FitModeEvaluators {
    ...
    private static final FitModeEvaluator f22101a = new FitModeEvaluator() {
        ...
        public boolean b(FitModeResult fitModeResult) {
            return fitModeResult.f22106d > fitModeResult.f22108f;
        }

        public void c(RectF rectF, float f2, FitModeResult fitModeResult) {
            rectF.bottom -= Math.abs(fitModeResult.f22108f - fitModeResult.f22106d) * f2;
        }
    };

    /* renamed from: b  reason: collision with root package name */
    private static final FitModeEvaluator f22102b = new FitModeEvaluator() {
        public FitModeResult a(float f2, float f3, float f4, float f5, float f6, float f7, float f8) {
        ...
        public boolean b(FitModeResult fitModeResult) {
            return fitModeResult.f22105c > fitModeResult.f22107e;
        }

        public void c(RectF rectF, float f2, FitModeResult fitModeResult) {
            float abs = (Math.abs(fitModeResult.f22107e - fitModeResult.f22105c) / 2.0f) * f2;
            rectF.left += abs;
            rectF.right -= abs;
        }
    };
    ...
    static FitModeEvaluator a(int i2, boolean z, RectF rectF, RectF rectF2) {
        if (i2 == 0) {
            return b(z, rectF, rectF2) ? f22101a : f22102b;
        }
        if (i2 == 1) {
            return f22101a;
        }
    ...
    private static boolean b(boolean r4, android.graphics.RectF r5, android.graphics.RectF r6) {
        ...
        L_0x0025:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.material.transition.FitModeEvaluators.b(boolean, android.graphics.RectF, android.graphics.RectF):boolean");
    }
}
