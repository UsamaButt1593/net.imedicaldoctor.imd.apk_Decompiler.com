...
class TransitionUtils {
    ...
    static final int f22145a = -1;
    @AttrRes

    /* renamed from: b  reason: collision with root package name */
    static final int f22146b = 0;

    /* renamed from: c  reason: collision with root package name */
    private static final int f22147c = 0;

    /* renamed from: d  reason: collision with root package name */
    private static final int f22148d = 1;

    /* renamed from: e  reason: collision with root package name */
    private static final RectF f22149e = new RectF();
    ...
    static boolean s(Transition transition, Context context, @AttrRes int i2) {
        int f2;
        if (i2 == 0 || transition.Q() != -1 || (f2 = MotionUtils.f(context, i2, -1)) == -1) {
            return false;
        }
        transition.k1((long) f2);
        return true;
    }
    ...
    static boolean t(Transition transition, Context context, @AttrRes int i2, TimeInterpolator timeInterpolator) {
        ...
        transition.r1(MotionUtils.g(context, i2, timeInterpolator));
        return true;
    }
