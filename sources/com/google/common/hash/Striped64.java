...
abstract class Striped64 extends Number {
    ...
    static final class Cell {
        ...
        volatile long f22710a;

        /* renamed from: b  reason: collision with root package name */
        volatile long f22711b;

        /* renamed from: c  reason: collision with root package name */
        volatile long f22712c;

        /* renamed from: d  reason: collision with root package name */
        volatile long f22713d;

        /* renamed from: e  reason: collision with root package name */
        volatile long f22714e;

        /* renamed from: f  reason: collision with root package name */
        volatile long f22715f;

        /* renamed from: g  reason: collision with root package name */
        volatile long f22716g;

        /* renamed from: h  reason: collision with root package name */
        volatile long f22717h;

        /* renamed from: i  reason: collision with root package name */
        volatile long f22718i;

        /* renamed from: j  reason: collision with root package name */
        volatile long f22719j;

        /* renamed from: k  reason: collision with root package name */
        volatile long f22720k;

        /* renamed from: l  reason: collision with root package name */
        volatile long f22721l;

        /* renamed from: m  reason: collision with root package name */
        volatile long f22722m;

        /* renamed from: n  reason: collision with root package name */
        volatile long f22723n;
        volatile long o;
    ...
    public static sun.misc.Unsafe h() {
        ...
        L_0x0011:
            ...
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.common.hash.Striped64.h():sun.misc.Unsafe");
    }
    ...
    public final void j(long r17, @javax.annotation.CheckForNull int[] r19, boolean r20) {
        ...
        L_0x001f:
            ...
            r5 = r20
        L_0x0023:
            com.google.common.hash.Striped64$Cell[] r9 = r1.s
            ...
            boolean r10 = r16.f()
            if (r10 == 0) goto L_0x0062
            com.google.common.hash.Striped64$Cell[] r10 = r1.s     // Catch:{ all -> 0x0056 }
        ...
        L_0x0076:
            ...
            com.google.common.hash.Striped64$Cell[] r11 = r1.s
        ...
        L_0x0083:
            ...
            boolean r11 = r16.f()
            if (r11 == 0) goto L_0x00ab
            com.google.common.hash.Striped64$Cell[] r8 = r1.s     // Catch:{ all -> 0x009f }
        ...
        L_0x00b8:
            ...
            com.google.common.hash.Striped64$Cell[] r10 = r1.s
            if (r10 != r9) goto L_0x00e5
            boolean r10 = r16.f()
            if (r10 == 0) goto L_0x00e5
            com.google.common.hash.Striped64$Cell[] r10 = r1.s     // Catch:{ all -> 0x00da }
