...
public final class ArrayListMultimap<K, V> extends ArrayListMultimapGwtSerializationDependencies<K, V> {
    ...
    public static <K, V> ArrayListMultimap<K, V> K(int i2, int i3) {
        return new ArrayListMultimap<>(i2, i3);
    }

    public static <K, V> ArrayListMultimap<K, V> L(Multimap<? extends K, ? extends V> multimap) {
    ...
    @Deprecated
    public void N() {
        for (Collection collection : t().values()) {
    ...
    @CanIgnoreReturnValue
    public /* bridge */ /* synthetic */ List c(@ParametricNullness Object obj, Iterable iterable) {
    ...
    private ArrayListMultimap(Multimap<? extends K, ? extends V> multimap) {
        this(multimap.keySet().size(), multimap instanceof ArrayListMultimap ? ((ArrayListMultimap) multimap).c3 : 3);
        Z(multimap);
    }
}
