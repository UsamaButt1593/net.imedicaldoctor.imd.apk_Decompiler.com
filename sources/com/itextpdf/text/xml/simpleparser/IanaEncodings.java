...
public class IanaEncodings {
    ...
    private static final Map<String, String> f27379a;
    ...
    static {
        ...
        hashMap.put("WINDOWS-1250", BaseFont.c4);
        ...
        hashMap.put("WINDOWS-1257", BaseFont.e4);
        ...
        hashMap.put("US-ASCII", NTLM.DEFAULT_CHARSET);
        hashMap.put("ISO-IR-6", NTLM.DEFAULT_CHARSET);
        hashMap.put("ANSI_X3.4-1986", NTLM.DEFAULT_CHARSET);
        hashMap.put("ISO_646.IRV:1991", NTLM.DEFAULT_CHARSET);
        hashMap.put(NTLM.DEFAULT_CHARSET, NTLM.DEFAULT_CHARSET);
        hashMap.put("CSASCII", NTLM.DEFAULT_CHARSET);
        hashMap.put("ISO646-US", NTLM.DEFAULT_CHARSET);
        hashMap.put("US", NTLM.DEFAULT_CHARSET);
        hashMap.put("IBM367", NTLM.DEFAULT_CHARSET);
        hashMap.put("CP367", NTLM.DEFAULT_CHARSET);
        hashMap.put("UTF-8", "UTF8");
        hashMap.put("UTF-16", "Unicode");
        hashMap.put("UTF-16BE", PdfObject.h3);
        hashMap.put("UTF-16LE", "UnicodeLittle");
    }

    public static String a(String str) {
        String str2 = f27379a.get(str.toUpperCase());
