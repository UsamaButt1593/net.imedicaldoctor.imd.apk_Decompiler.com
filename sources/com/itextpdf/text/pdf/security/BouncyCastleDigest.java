...
public class BouncyCastleDigest implements ExternalDigest {
    public MessageDigest a(String str) throws GeneralSecurityException {
        ...
        } else if (c2.equals("1.2.840.113549.2.2")) {
            return new MD2.Digest();
        } else {
            if (c2.equals("1.2.840.113549.2.5")) {
                return new MD5.Digest();
            }
            if (c2.equals("1.3.14.3.2.26")) {
                return new SHA1.Digest();
            }
            if (c2.equals("2.16.840.1.101.3.4.2.4")) {
                return new SHA224.Digest();
            }
            if (c2.equals("2.16.840.1.101.3.4.2.1")) {
                return new SHA256.Digest();
            }
            if (c2.equals("2.16.840.1.101.3.4.2.2")) {
                return new SHA384.Digest();
            }
            if (c2.equals("2.16.840.1.101.3.4.2.3")) {
                return new SHA512.Digest();
            }
            if (c2.equals("1.3.36.3.2.2")) {
                return new RIPEMD128.Digest();
            }
            if (c2.equals("1.3.36.3.2.1")) {
                return new RIPEMD160.Digest();
            }
            if (c2.equals("1.3.36.3.2.3")) {
                return new RIPEMD256.Digest();
            }
            if (c2.equals("1.2.643.2.2.9")) {
