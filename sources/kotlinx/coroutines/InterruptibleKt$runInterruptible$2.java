...
final class InterruptibleKt$runInterruptible$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super T>, Object> {
    ...
    final /* synthetic */ Function0<T> Z2;
    ...
    public final Object D(@NotNull Object obj) {
        ...
        if (this.X2 == 0) {
            ResultKt.n(obj);
            return InterruptibleKt.d(((CoroutineScope) this.Y2).U(), this.Z2);
        }
    ...
    public final Object d0(@NotNull CoroutineScope coroutineScope, @Nullable Continuation<? super T> continuation) {
        return ((InterruptibleKt$runInterruptible$2) v(coroutineScope, continuation)).D(Unit.f28779a);
    }

    @NotNull
    public final Continuation<Unit> v(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        InterruptibleKt$runInterruptible$2 interruptibleKt$runInterruptible$2 = new InterruptibleKt$runInterruptible$2(this.Z2, continuation);
        interruptibleKt$runInterruptible$2.Y2 = obj;
