...
final class FlowKt__MergeKt$mapLatest$1 extends SuspendLambda implements Function3<FlowCollector<? super R>, T, Continuation<? super Unit>, Object> {
    ...
    public final java.lang.Object D(@org.jetbrains.annotations.NotNull java.lang.Object r6) {
        ...
        L_0x0045:
            ...
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.flow.FlowKt__MergeKt$mapLatest$1.D(java.lang.Object):java.lang.Object");
    }

    @Nullable
    /* renamed from: U */
    public final Object A(@NotNull FlowCollector<? super R> flowCollector, T t, @Nullable Continuation<? super Unit> continuation) {
        FlowKt__MergeKt$mapLatest$1 flowKt__MergeKt$mapLatest$1 = new FlowKt__MergeKt$mapLatest$1(this.a3, continuation);
        flowKt__MergeKt$mapLatest$1.Y2 = flowCollector;
        flowKt__MergeKt$mapLatest$1.Z2 = t;
        return flowKt__MergeKt$mapLatest$1.D(Unit.f28779a);
    }
}
