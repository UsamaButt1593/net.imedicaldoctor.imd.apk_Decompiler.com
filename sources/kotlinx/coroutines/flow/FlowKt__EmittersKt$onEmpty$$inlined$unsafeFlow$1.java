...
public final class FlowKt__EmittersKt$onEmpty$$inlined$unsafeFlow$1 implements Flow<T> {
    ...
    public java.lang.Object a(@org.jetbrains.annotations.NotNull kotlinx.coroutines.flow.FlowCollector<? super T> r7, @org.jetbrains.annotations.NotNull kotlin.coroutines.Continuation<? super kotlin.Unit> r8) {
        ...
        L_0x0018:
            ...
            kotlin.ResultKt.n(r8)     // Catch:{ all -> 0x0030 }
            goto L_0x0094
        L_0x0030:
            r8 = move-exception
            goto L_0x0098
        ...
        L_0x004a:
            ...
            r8.<init>()
            r8.s = r4
            kotlinx.coroutines.flow.Flow r2 = r6.s
        ...
        L_0x006d:
            ...
            kotlin.coroutines.CoroutineContext r8 = r0.g()
            r7.<init>(r2, r8)
            kotlin.jvm.functions.Function2 r8 = r4.X     // Catch:{ all -> 0x0030 }
            r0.Z2 = r7     // Catch:{ all -> 0x0030 }
            r2 = 0
            r0.a3 = r2     // Catch:{ all -> 0x0030 }
            r0.b3 = r2     // Catch:{ all -> 0x0030 }
            r0.X2 = r3     // Catch:{ all -> 0x0030 }
            r2 = 6
            kotlin.jvm.internal.InlineMarker.e(r2)     // Catch:{ all -> 0x0030 }
            java.lang.Object r8 = r8.d0(r7, r0)     // Catch:{ all -> 0x0030 }
            r0 = 7
            kotlin.jvm.internal.InlineMarker.e(r0)     // Catch:{ all -> 0x0030 }
