...
public final class FlowCoroutineKt$scopedFlow$$inlined$unsafeFlow$1 implements Flow<R> {
    ...
    public Object a(@NotNull FlowCollector<? super R> flowCollector, @NotNull Continuation<? super Unit> continuation) {
        Object a2 = FlowCoroutineKt.a(new FlowCoroutineKt$scopedFlow$1$1(this.s, flowCollector, (Continuation<? super FlowCoroutineKt$scopedFlow$1$1>) null), continuation);
