...
final class ChannelLimitedFlowMerge$collectTo$2$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    int X2;
    final /* synthetic */ Flow<T> Y2;
    final /* synthetic */ SendingCollector<T> Z2;
    ...
    public final Object D(@NotNull Object obj) {
        ...
        if (i2 == 0) {
            ResultKt.n(obj);
            Flow<T> flow = this.Y2;
            SendingCollector<T> sendingCollector = this.Z2;
            this.X2 = 1;
            if (flow.a(sendingCollector, this) == l2) {
                return l2;
            }
        } else if (i2 == 1) {
            ResultKt.n(obj);
    ...
    public final Object d0(@NotNull CoroutineScope coroutineScope, @Nullable Continuation<? super Unit> continuation) {
        return ((ChannelLimitedFlowMerge$collectTo$2$1) v(coroutineScope, continuation)).D(Unit.f28779a);
    }

    @NotNull
    public final Continuation<Unit> v(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new ChannelLimitedFlowMerge$collectTo$2$1(this.Y2, this.Z2, continuation);
    }
}
