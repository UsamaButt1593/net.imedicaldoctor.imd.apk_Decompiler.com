...
public final class FlowKt__ZipKt$combine$$inlined$unsafeFlow$3 implements Flow<R> {
    ...
    public Object a(@NotNull FlowCollector<? super R> flowCollector, @NotNull Continuation<? super Unit> continuation) {
        Flow[] flowArr = this.s;
        Intrinsics.w();
        FlowKt__ZipKt$combine$6$1 flowKt__ZipKt$combine$6$1 = new FlowKt__ZipKt$combine$6$1(this.s);
        Intrinsics.w();
        Object a2 = CombineKt.a(flowCollector, flowArr, flowKt__ZipKt$combine$6$1, new FlowKt__ZipKt$combine$6$2(this.X, (Continuation<? super FlowKt__ZipKt$combine$6$2>) null), continuation);
    ...
    public Object d(@NotNull FlowCollector flowCollector, @NotNull Continuation continuation) {
        ...
        new ContinuationImpl(this, continuation) {
            int X2;
            final /* synthetic */ FlowKt__ZipKt$combine$$inlined$unsafeFlow$3 Y2;
            /* synthetic */ Object Z;
        ...
        FlowKt__ZipKt$combine$6$1 flowKt__ZipKt$combine$6$1 = new FlowKt__ZipKt$combine$6$1(this.s);
        Intrinsics.w();
        FlowKt__ZipKt$combine$6$2 flowKt__ZipKt$combine$6$2 = new FlowKt__ZipKt$combine$6$2(this.X, (Continuation<? super FlowKt__ZipKt$combine$6$2>) null);
        InlineMarker.e(0);
        CombineKt.a(flowCollector, flowArr, flowKt__ZipKt$combine$6$1, flowKt__ZipKt$combine$6$2, continuation);
        InlineMarker.e(1);
        return Unit.f28779a;
    }
}
