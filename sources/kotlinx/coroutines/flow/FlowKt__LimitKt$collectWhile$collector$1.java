...
public final class FlowKt__LimitKt$collectWhile$collector$1 implements FlowCollector<T> {
    ...
    public Object a(T t, @NotNull Continuation<? super Unit> continuation) {
        ...
        InlineMarker.e(5);
        if (((Boolean) this.s.d0(t, continuation)).booleanValue()) {
            return Unit.f28779a;
        }
    ...
    public java.lang.Object h(T r5, @org.jetbrains.annotations.NotNull kotlin.coroutines.Continuation<? super kotlin.Unit> r6) {
        ...
        L_0x0051:
            ...
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.flow.FlowKt__LimitKt$collectWhile$collector$1.h(java.lang.Object, kotlin.coroutines.Continuation):java.lang.Object");
    }
}
