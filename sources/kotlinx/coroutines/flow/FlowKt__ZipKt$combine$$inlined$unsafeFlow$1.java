...
public final class FlowKt__ZipKt$combine$$inlined$unsafeFlow$1 implements Flow<R> {
    ...
    public Object a(@NotNull FlowCollector<? super R> flowCollector, @NotNull Continuation<? super Unit> continuation) {
        Object a2 = CombineKt.a(flowCollector, new Flow[]{this.s, this.X}, FlowKt__ZipKt.r(), new FlowKt__ZipKt$combine$1$1(this.Y, (Continuation<? super FlowKt__ZipKt$combine$1$1>) null), continuation);
