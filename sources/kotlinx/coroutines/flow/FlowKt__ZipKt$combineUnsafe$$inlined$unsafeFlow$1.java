...
public final class FlowKt__ZipKt$combineUnsafe$$inlined$unsafeFlow$1 implements Flow<R> {
    ...
    public Object a(@NotNull FlowCollector<? super R> flowCollector, @NotNull Continuation<? super Unit> continuation) {
        ...
        Intrinsics.w();
        Object a3 = CombineKt.a(flowCollector, flowArr, a2, new FlowKt__ZipKt$combineUnsafe$1$1(this.X, (Continuation<? super FlowKt__ZipKt$combineUnsafe$1$1>) null), continuation);
    ...
    public Object d(@NotNull FlowCollector flowCollector, @NotNull Continuation continuation) {
        ...
        new ContinuationImpl(this, continuation) {
            int X2;
            final /* synthetic */ FlowKt__ZipKt$combineUnsafe$$inlined$unsafeFlow$1 Y2;
            /* synthetic */ Object Z;
        ...
        Function0 a2 = FlowKt__ZipKt.r();
        Intrinsics.w();
        FlowKt__ZipKt$combineUnsafe$1$1 flowKt__ZipKt$combineUnsafe$1$1 = new FlowKt__ZipKt$combineUnsafe$1$1(this.X, (Continuation<? super FlowKt__ZipKt$combineUnsafe$1$1>) null);
        InlineMarker.e(0);
        CombineKt.a(flowCollector, flowArr, a2, flowKt__ZipKt$combineUnsafe$1$1, continuation);
        InlineMarker.e(1);
        return Unit.f28779a;
    }
}
