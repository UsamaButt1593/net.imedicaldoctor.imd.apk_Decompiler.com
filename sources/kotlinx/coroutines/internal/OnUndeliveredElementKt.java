...
public final class OnUndeliveredElementKt {
    ...
    public static final <E> void b(@NotNull Function1<? super E, Unit> function1, E e2, @NotNull CoroutineContext coroutineContext) {
        UndeliveredElementException c2 = c(function1, e2, (UndeliveredElementException) null);
        if (c2 != null) {
            CoroutineExceptionHandlerKt.b(coroutineContext, c2);
        }
    }

    @Nullable
    public static final <E> UndeliveredElementException c(@NotNull Function1<? super E, Unit> function1, E e2, @Nullable UndeliveredElementException undeliveredElementException) {
        try {
            function1.f(e2);
        } catch (Throwable th) {
