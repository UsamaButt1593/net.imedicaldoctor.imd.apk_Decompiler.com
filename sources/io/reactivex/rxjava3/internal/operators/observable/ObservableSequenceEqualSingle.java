...
public final class ObservableSequenceEqualSingle<T> extends Single<Boolean> implements FuseToObservable<Boolean> {
    ...
    public void O1(SingleObserver<? super Boolean> singleObserver) {
        EqualCoordinator equalCoordinator = new EqualCoordinator(singleObserver, this.Z, this.s, this.X, this.Y);
        singleObserver.b(equalCoordinator);
        equalCoordinator.d();
    }

    public Observable<Boolean> c() {
        return RxJavaPlugins.R(new ObservableSequenceEqual(this.s, this.X, this.Y, this.Z));
    }
}
