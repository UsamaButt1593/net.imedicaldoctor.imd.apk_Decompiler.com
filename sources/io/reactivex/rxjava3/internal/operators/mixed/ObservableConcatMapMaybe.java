...
public final class ObservableConcatMapMaybe<T, R> extends Observable<R> {
    ...
    static final class ConcatMapMaybeMainObserver<T, R> extends AtomicInteger implements Observer<T>, Disposable {
        ...
        final ErrorMode Y2;
        final ConcatMapMaybeObserver<R> Z = new ConcatMapMaybeObserver<>(this);
        Disposable Z2;
        volatile boolean a3;
        volatile boolean b3;
        R c3;
        ...
        static final class ConcatMapMaybeObserver<R> extends AtomicReference<Disposable> implements MaybeObserver<R> {
            ...
            final ConcatMapMaybeMainObserver<?, R> s;
    ...
    public void g6(Observer<? super R> observer) {
        if (!ScalarXMapZHelper.b(this.s, this.X, observer)) {
            this.s.a(new ConcatMapMaybeMainObserver(observer, this.X, this.Z, this.Y));
        }
    }
}
