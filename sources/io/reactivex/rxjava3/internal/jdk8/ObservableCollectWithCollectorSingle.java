...
public final class ObservableCollectWithCollectorSingle<T, A, R> extends Single<R> implements FuseToObservable<R> {
    ...
    public void O1(@NonNull SingleObserver<? super R> singleObserver) {
        try {
            this.s.a(new CollectorSingleObserver(singleObserver, this.X.supplier().get(), this.X.accumulator(), this.X.finisher()));
        } catch (Throwable th) {
            Exceptions.b(th);
    ...
    public Observable<R> c() {
        return new ObservableCollectWithCollector(this.s, this.X);
    }
}
