...
public final class SQLiteConnectionPool implements Closeable {
    ...
    private void closeConnectionAndLogExceptionsLocked(SQLiteConnection sQLiteConnection) {
        try {
            ...
            Log.e(TAG, "Failed to close connection, its fate is now in the hands of the merciful GC: " + sQLiteConnection, e2);
        }
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:33:0x0068, code lost:
        r10.d(new io.requery.android.database.sqlite.SQLiteConnectionPool.AnonymousClass1(r9));
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:69:0x00c6, code lost:
        r10.d((androidx.core.os.CancellationSignal.OnCancelListener) null);
     */
    ...
    private io.requery.android.database.sqlite.SQLiteConnection waitForConnection(java.lang.String r19, int r20, androidx.core.os.CancellationSignal r21) {
        /*
            r18 = this;
            r9 = r18
            r0 = r20
        ...
        L_0x001e:
            ...
            io.requery.android.database.sqlite.SQLiteConnection r1 = r18.tryAcquireNonPrimaryConnectionLocked(r19, r20)     // Catch:{ all -> 0x001b }
            goto L_0x0027
        L_0x0026:
            r1 = r14
        L_0x0027:
            if (r1 != 0) goto L_0x002d
            io.requery.android.database.sqlite.SQLiteConnection r1 = r9.tryAcquirePrimaryConnectionLocked(r0)     // Catch:{ all -> 0x001b }
        L_0x002d:
        ...
        L_0x0031:
            ...
            r7 = r19
            r8 = r20
            io.requery.android.database.sqlite.SQLiteConnectionPool$ConnectionWaiter r1 = r1.obtainConnectionWaiterLocked(r2, r3, r5, r6, r7, r8)     // Catch:{ all -> 0x001b }
            io.requery.android.database.sqlite.SQLiteConnectionPool$ConnectionWaiter r2 = r9.mConnectionWaiterQueue     // Catch:{ all -> 0x001b }
            r3 = r14
        L_0x004b:
            ...
            goto L_0x005c
        L_0x0054:
            io.requery.android.database.sqlite.SQLiteConnectionPool$ConnectionWaiter r3 = r2.mNext     // Catch:{ all -> 0x001b }
            r17 = r3
            r3 = r2
            r2 = r17
            goto L_0x004b
        ...
        L_0x0063:
            ...
            io.requery.android.database.sqlite.SQLiteConnectionPool$1 r3 = new io.requery.android.database.sqlite.SQLiteConnectionPool$1
            r3.<init>(r1, r2)
            r10.d(r3)
        L_0x0070:
        ...
        L_0x008b:
            ...
            io.requery.android.database.sqlite.SQLiteConnection r7 = r1.mAssignedConnection     // Catch:{ all -> 0x00bc }
        ...
        L_0x00d3:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: io.requery.android.database.sqlite.SQLiteConnectionPool.waitForConnection(java.lang.String, int, androidx.core.os.CancellationSignal):io.requery.android.database.sqlite.SQLiteConnection");
    }
